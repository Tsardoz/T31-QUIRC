...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/runner/output/toolchain_xburst1_musl_gcc13/host/mipsel-thingino-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
